...
public abstract class FlexoResourceFactory<R extends FlexoResource<RD>, RD extends ResourceData<RD>> extends PamelaModelFactory
     ...
     * @param serializationArtefact
     * @param resourceCenter
     * @param createEmptyContents   when set to true, initiate contents of resource with technology specific empty contents
     * @return
     * @throws SaveResourceException
     * @throws ModelDefinitionException
     */
     ...
     * @param name
     * @param uri
     * @param specializedResourceDataClass might be null if default, or specialized resource data class
     * @param createEmptyContents          when set to true, initiate contents of resource with technology specific empty contents
     * @return
     * @throws SaveResourceException
     * @throws ModelDefinitionException
    ...
    /**
     * @throws ModelDefinitionException raised by children
     */
    ...
    /**
     * @throws ModelDefinitionException raised by children
     * @throws IOException              raised by children
     */
