...
public final class AConstantCompositeIdent extends PCompositeIdent
{
    ...
    public Object clone()
    {
        return new AConstantCompositeIdent(
    ...
    {
        ((Analysis) sw).caseAConstantCompositeIdent(this);
    }
