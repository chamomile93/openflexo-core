...
public final class AFullQualifiedFmlParameters extends PFmlParameters {
    private TLPar _lPar_;
    private PQualifiedArgumentList _qualifiedArgumentList_;
    private TRPar _rPar_;

    public AFullQualifiedFmlParameters() {
        // Constructor
    }
    ...
    @Override
    public Object clone() {
        return new AFullQualifiedFmlParameters(
    ...
    public void apply(Switch sw) {
        ((Analysis) sw).caseAFullQualifiedFmlParameters(this);
    }
