...
public final class AConstantIdentifier extends PIdentifier
{
    private TCidentifier _cidentifier_;

    public AConstantIdentifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstantIdentifier(
    ...
    {
        ((Analysis) sw).caseAConstantIdentifier(this);
    }
