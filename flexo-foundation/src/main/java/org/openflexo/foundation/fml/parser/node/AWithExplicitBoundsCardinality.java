...
public final class AWithExplicitBoundsCardinality extends PCardinality
{
    ...
    public AWithExplicitBoundsCardinality()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AWithExplicitBoundsCardinality(
    ...
    {
        ((Analysis) sw).caseAWithExplicitBoundsCardinality(this);
    }
