...
public final class ANamedConstructorBehaviourDecl extends PBehaviourDecl
{
    ...
    public ANamedConstructorBehaviourDecl()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANamedConstructorBehaviourDecl(
    ...
    {
        ((Analysis) sw).caseANamedConstructorBehaviourDecl(this);
    }
