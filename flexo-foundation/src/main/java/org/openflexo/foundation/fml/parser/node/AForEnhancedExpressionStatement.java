...
public final class AForEnhancedExpressionStatement extends PStatement {
    ...
    public AForEnhancedExpressionStatement() {
        // Constructor
    }
    ...
    @Override
    public Object clone() {
        return new AForEnhancedExpressionStatement(
    ...
    public void apply(Switch sw) {
        ((Analysis) sw).caseAForEnhancedExpressionStatement(this);
    }
