...
public final class ALiteralPrimaryNoId extends PPrimaryNoId
{
    private PLiteral _literal_;

    public ALiteralPrimaryNoId()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALiteralPrimaryNoId(
    ...
    {
        ((Analysis) sw).caseALiteralPrimaryNoId(this);
    }
