...
public final class AMethodBehaviourDecl extends PBehaviourDecl
{
    ...
    public Object clone()
    {
        return new AMethodBehaviourDecl(
    ...
    {
        ((Analysis) sw).caseAMethodBehaviourDecl(this);
    }
