...
public final class AUidentifierUriExpressionPrimary extends PUriExpressionPrimary
{
    private TUidentifier _uidentifier_;

    public AUidentifierUriExpressionPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUidentifierUriExpressionPrimary(
    ...
    {
        ((Analysis) sw).caseAUidentifierUriExpressionPrimary(this);
    }
