...
public final class ANormalTypeDeclType extends PTypeDeclType {
    private PReferenceType _referenceType_;

    public ANormalTypeDeclType() {
        // Constructor
    }
    ...
    @Override
    public Object clone() {
        return new ANormalTypeDeclType(
                cloneNode(this._referenceType_));
    }

    @Override
    public void apply(Switch sw) {
        ((Analysis) sw).caseANormalTypeDeclType(this);
    }
