...
public class Property {
    ...
    /**
     * @param label          Name of the property (e.g. font-weight)
     * @param value          Value of the property (e.g. bold)
     * @param possibleValues List of the possible values for attribute value (e.g. ['bold', 'normal', 'light']).
